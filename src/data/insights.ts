...
export const insights: InsightMeta[] = [
  ...
  },
  {
    ...
    references: [
      {
        citation: "H. Lu et al., Solar Energy Materials and Solar Cells 295, 114016 (2026).",
        href: "https://doi.org/10.1016/j.solmat.2025.114016"
      },
      {
        citation: "H. Lu, Strain engineering and buffer-layer design for VO₂-based functional thin-film devices, doctoral thesis (2025).",
  ...
  },
  {
    ...
    references: [
      {
        citation: "S. Maruo, O. Nakamura and S. Kawata, Optics Letters 22, 132-134 (1997).",
  ...
  },
  {
    ...
    references: [
      {
        citation: "E. Kusano, Applied Science and Convergence Technology 28, 179-185 (2019).",
        href: "https://doi.org/10.5757/ASCT.2019.28.6.179"
      }
    ]
  },
  {
    ...
    references: [
      {
        citation: "K. Liu et al., Advanced Electronic Materials 10, 2300699 (2024).",
        href: "https://doi.org/10.1002/aelm.202300699"
      },
      {
        citation: "H. Lu, Strain engineering and buffer-layer design for VO₂-based functional thin-film devices, doctoral thesis (2025).",
        href: "https://doi.org/10.22029/jlupub-20608"
  ...
  },
  {
    ...
    references: [
      {
        citation: "G. Giusi et al., Sensors 23, 2727 (2023).",
        href: "https://doi.org/10.3390/s23052727"
      },
      {
        citation: "X. Wang et al., Nanomaterials 15, 1316 (2025).",
        href: "https://doi.org/10.3390/nano15171316"
      }
    ]
  },
  {
    ...
    references: [
      ...
      {
        citation: "H. Lu et al., Applied Physics Letters 116, 192103 (2020).",
        href: "https://doi.org/10.1063/5.0005426"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    references: [
      ...
      {
        citation: "H. Lu et al., Applied Physics Letters 123, 042103 (2023).",
        href: "https://doi.org/10.1063/5.0152809"
      }
    ]
  },
  {
    ...
    references: [
      {
        ...
        href: "https://doi.org/10.1126/science.aan8871"
      },
      {
        citation: "C. Mead, Proceedings of the IEEE 78, 1629-1636 (1990).",
  ...
  },
  {
    ...
    references: [
      {
        citation: "L. G. Parratt, Physical Review 95, 359-369 (1954).",
        href: "https://doi.org/10.1103/PhysRev.95.359"
      },
      {
        citation: "H. Lu, Strain engineering and buffer-layer design for VO₂-based functional thin-film devices, doctoral thesis (2025).",
        href: "https://doi.org/10.22029/jlupub-20608"
  ...
  },
  {
    ...
    references: [
      {
        citation: "J. C. Parker et al., Journal of the American Ceramic Society 73, 3206-3208 (1990).",
        href: "https://doi.org/10.1111/j.1151-2916.1990.tb06438.x"
      },
      {
        citation: "C. Lamsal and N. M. Ravindra, Journal of Materials Science 48, 6341-6351 (2013).",
        href: "https://doi.org/10.1007/s10853-013-7433-3"
      }
    ]
  }
];
